...
const syllabus: ChapterEntry[] = [
  // ── JUNE ──────────────────────────────────────────────────────────────────────
  { subject: 'PHYSICS',   chapterName: 'Units and Measurements',               scheduledMonth: 6,  chapterOrder: 1, globalOrder: 1  },
  { subject: 'PHYSICS',   chapterName: 'Atoms',                                scheduledMonth: 6,  chapterOrder: 2, globalOrder: 2  },
  { subject: 'PHYSICS',   chapterName: 'Nuclei',                               scheduledMonth: 6,  chapterOrder: 3, globalOrder: 3  },
  { subject: 'PHYSICS',   chapterName: 'Dual Nature',                          scheduledMonth: 6,  chapterOrder: 4, globalOrder: 4  },
  ...
  { subject: 'PHYSICS',   chapterName: 'Wave Optics',                          scheduledMonth: 7,  chapterOrder: 2, globalOrder: 6  },
  { subject: 'PHYSICS',   chapterName: 'Electromagnetic Waves',                scheduledMonth: 7,  chapterOrder: 3, globalOrder: 7  },
  ...
  { subject: 'PHYSICS',   chapterName: '2D',                                   scheduledMonth: 8,  chapterOrder: 2, globalOrder: 9  },
  { subject: 'PHYSICS',   chapterName: 'Laws of Motion (w/o Circular)',        scheduledMonth: 8,  chapterOrder: 3, globalOrder: 10 },
  { subject: 'PHYSICS',   chapterName: 'Work Energy and Power',                scheduledMonth: 8,  chapterOrder: 4, globalOrder: 11 },
  { subject: 'CHEMISTRY', chapterName: 'Some Basic Concepts of Chemistry',     scheduledMonth: 8,  chapterOrder: 1, globalOrder: 7  },
  ...
  { subject: 'PHYSICS',   chapterName: 'System of Particles and Rotational Motion', scheduledMonth: 9, chapterOrder: 2, globalOrder: 13 },
  { subject: 'PHYSICS',   chapterName: 'Gravitation',                           scheduledMonth: 9,  chapterOrder: 3, globalOrder: 14 },
  { subject: 'PHYSICS',   chapterName: 'Oscillations',                          scheduledMonth: 9,  chapterOrder: 4, globalOrder: 15 },
  ...
  { subject: 'PHYSICS',   chapterName: 'Mechanical Properties of Fluids',       scheduledMonth: 10, chapterOrder: 2, globalOrder: 17 },
  { subject: 'PHYSICS',   chapterName: 'Thermal Properties of Matter',          scheduledMonth: 10, chapterOrder: 3, globalOrder: 18 },
  { subject: 'PHYSICS',   chapterName: 'Thermodynamics',                        scheduledMonth: 10, chapterOrder: 4, globalOrder: 19 },
  { subject: 'PHYSICS',   chapterName: 'Kinetic Theory',                        scheduledMonth: 10, chapterOrder: 5, globalOrder: 20 },
  { subject: 'CHEMISTRY', chapterName: 'Hydrocarbons',                          scheduledMonth: 10, chapterOrder: 1, globalOrder: 14 },
  ...
  { subject: 'PHYSICS',   chapterName: 'Electrostatic Potential and Capacitance', scheduledMonth: 11, chapterOrder: 2, globalOrder: 22 },
  { subject: 'PHYSICS',   chapterName: 'Current Electricity',                   scheduledMonth: 11, chapterOrder: 3, globalOrder: 23 },
  { subject: 'PHYSICS',   chapterName: 'Moving Charges and Magnetism',          scheduledMonth: 11, chapterOrder: 4, globalOrder: 24 },
  ...
  { subject: 'PHYSICS',   chapterName: 'AC',                                    scheduledMonth: 12, chapterOrder: 2, globalOrder: 26 },
  { subject: 'PHYSICS',   chapterName: 'Semiconductors',                        scheduledMonth: 12, chapterOrder: 3, globalOrder: 27 },
  { subject: 'PHYSICS',   chapterName: 'Ray Optics and Optical Instruments',    scheduledMonth: 12, chapterOrder: 4, globalOrder: 28 },
  { subject: 'PHYSICS',   chapterName: 'Experimental Skills',                   scheduledMonth: 12, chapterOrder: 5, globalOrder: 29 },
  { subject: 'CHEMISTRY', chapterName: 'Coordination Compounds',                scheduledMonth: 12, chapterOrder: 1, globalOrder: 21 },
...
async function seedSyllabus() {
  ...
  // 1. Upsert all chapters without parent links
  // $setOnInsert is not needed for subject/chapterName: MongoDB includes filter fields
  // in the inserted doc automatically on upsert.
  ...
  // 2. Link Part 2 → Part 1 for split chapters.
  ...
  // 3. Validate counts — throw so CI catches a syllabus data mismatch
  ...
  console.log(`  TOTAL: ${total} (expected 85)`)
  if (total !== 85) throw new Error(`Syllabus seed count mismatch: expected 85, got ${total}`)
