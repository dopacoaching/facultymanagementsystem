...
async function seed() {
  ...
  const facultyDocs = await Faculty.insertMany([
    ...
    // 20 – Shahid — office staff: fixed base + extra hours beyond 80h (see OFFICE_STAFF_LEAVE_BASED)
    { name: 'Shahid', subject: 'Chemistry', type: 'PERMANENT', salaryModel: 'FIXED_MONTHLY', fixedMonthlySalary: e('SALARY_SHAHID_FIXED', 55000), overtimeThreshold: e('SALARY_SHAHID_OT_THRESHOLD', 80), overtimeRate: e('SALARY_SHAHID_OT_RATE', 600) },
  ...
  await PermanentFacultyContract.insertMany([
    ...
    { facultyId: byName['Anand K'],            contractType: 'FIXED_QUOTA_CARRYFORWARD', fixedMonthlySalary: e('SALARY_ANAND_FIXED', 120000),            monthlyHourQuota: e('SALARY_ANAND_QUOTA_HRS', 135),        hasCarryForward: true, notes: 'Biology. Full salary paid regardless of hours. 135h monthly quota; deficit carried forward to next month (surplus reduces accumulated deficit).' },
    ...
    { facultyId: byName['Parvathy'],           contractType: 'OFFICE_STAFF_LEAVE_BASED', fixedMonthlySalary: e('SALARY_DOUBT_FIXED', 20000),           overtimeThresholdHours: e('SALARY_DOUBT_THRESHOLD', 18), overtimeRatePerHour: e('SALARY_DOUBT_OT_RATE', 300), classRatePerHour: e('SALARY_DOUBT_CLASS_RATE', 550), notes: 'Doubt clearance. Office staff: ₹20,000 base, reduced per unpaid day beyond HR-entered Payable Days. ₹300/hr beyond 18 doubt-clearance hours; ₹550/hr for every class hour.' },
    { facultyId: byName['Thamanna'],           contractType: 'OFFICE_STAFF_LEAVE_BASED', fixedMonthlySalary: e('SALARY_DOUBT_FIXED', 20000),           overtimeThresholdHours: e('SALARY_DOUBT_THRESHOLD', 18), overtimeRatePerHour: e('SALARY_DOUBT_OT_RATE', 300), classRatePerHour: e('SALARY_DOUBT_CLASS_RATE', 550), notes: 'Doubt clearance. Office staff: ₹20,000 base, reduced per unpaid day beyond HR-entered Payable Days. ₹300/hr beyond 18 doubt-clearance hours; ₹550/hr for every class hour.' },
    { facultyId: byName['Manju'],              contractType: 'OFFICE_STAFF_LEAVE_BASED', fixedMonthlySalary: e('SALARY_DOUBT_FIXED', 20000),           overtimeThresholdHours: e('SALARY_DOUBT_THRESHOLD', 18), overtimeRatePerHour: e('SALARY_DOUBT_OT_RATE', 300), classRatePerHour: e('SALARY_DOUBT_CLASS_RATE', 550), notes: 'Doubt clearance. Office staff: ₹20,000 base, reduced per unpaid day beyond HR-entered Payable Days. ₹300/hr beyond 18 doubt-clearance hours; ₹550/hr for every class hour.' },
    ...
    { facultyId: byName['Shahid'],             contractType: 'OFFICE_STAFF_LEAVE_BASED', fixedMonthlySalary: e('SALARY_SHAHID_FIXED', 55000),            overtimeThresholdHours: e('SALARY_SHAHID_OT_THRESHOLD', 80), overtimeRatePerHour: e('SALARY_SHAHID_OT_RATE', 600), notes: 'Chemistry. Office staff: ₹55,000 base, reduced per unpaid day beyond HR-entered Payable Days. +₹600/hr beyond 80 hours.' },
    { facultyId: byName['Theertha'],           contractType: 'OFFICE_STAFF_LEAVE_BASED', fixedMonthlySalary: e('SALARY_THEERTHA_FIXED', 15000),          overtimeThresholdHours: e('SALARY_THEERTHA_OT_THRESHOLD', 18), overtimeRatePerHour: e('SALARY_THEERTHA_OT_RATE', 200), notes: 'Chemistry. Office staff: ₹15,000 base, reduced per unpaid day beyond HR-entered Payable Days. +₹200/hr beyond 18 hours.' },
  ])
