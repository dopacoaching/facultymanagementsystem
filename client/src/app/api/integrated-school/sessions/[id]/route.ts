...
/** PATCH /api/integrated-school/sessions/:id — full edit (manager only) */
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const forbidden = authorize(payload, 'IS_ACADEMICS_MANAGER', 'HR_MANAGER', 'ADMIN')
    ...
    console.error('[PATCH /api/integrated-school/sessions/:id]', err)
