...
.hdr{display:flex;justify-content:space-between;align-items:flex-start;border-bottom:2.5px solid #2563eb;padding-bottom:1.25rem;margin-bottom:1.5rem}
.org{font-size:1.375rem;font-weight:800;color:#2563eb;letter-spacing:-.02em}
...
.total-row td{border-top:2px solid #2563eb;padding-top:.75rem;font-size:1rem;font-weight:800;color:#2563eb;border-bottom:none}
...
.print-btn{position:fixed;bottom:1.5rem;right:1.5rem;background:#2563eb;color:#fff;border:none;border-radius:50px;padding:.75rem 1.5rem;font-size:1rem;font-weight:700;cursor:pointer;box-shadow:0 4px 16px rgba(37,99,235,.35)}
